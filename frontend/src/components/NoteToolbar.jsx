...
export function CopyNoteButton({ note }) {
    ...
    return (
        <button className="ag-toolbar-icon-btn" onClick={copy} title="Copy full note as Markdown" style={tbBtn}>
...
export function DownloadNoteButton({ note, name }) {
    ...
    return (
        <button className="ag-toolbar-icon-btn" onClick={dl} title="Download as .md" style={tbBtn}>
...
export function PrintNoteButton({ onPrint }) {
    return (
        <button className="ag-toolbar-icon-btn" onClick={onPrint} title="Print / Export as PDF" style={tbBtn}>
