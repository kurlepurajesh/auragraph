...
export function useSidebar() {
    ...
    const startResizeSidebar = useCallback((e) => {
        ...
        const onMove = (ev) => {
            ...
            // Keep panel wide enough to be useful, and allow drag expansion up to 50% of viewport width.
            const minWidth = 280;
            const maxWidth = Math.floor(window.innerWidth * 0.5);
            setSidebarWidth(Math.max(minWidth, Math.min(maxWidth, startW + delta)));
        };
        const onUp = () => {
